...
<div class="wrapper">
    ...
    <!-- Контент орамасы. Бет мазмұнын қамтиды -->
    <div class="content-wrapper">
        <!-- Контент тақырыбы (Бет тақырыбы) -->
        <section class="content-header">
            <h1>
                Барлық дауыстарды басқару
            </h1>
        </section>
        <!-- Негізгі мазмұн -->
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <a href="#reset" data-toggle="modal" class="btn btn-danger btn-sm btn-flat"><i class="fa fa-refresh"></i> Қалпына келтіру</a>
                        </div>
                        <div class="box-body">
                            <table id="example1" class="table table-bordered">
                                ...
                                <th class="hidden"></th>
                                <th>Позиция</th>
                                <th>Кандидаттың аты-жөні</th>
                                <th>Сайлаушының аты-жөні</th>
                                </thead>
                                <tbody>
                                <?php
